    ...
    if file_path1 == "Choose File" or file_path2 == "Choose File":
        ...
        if ratio > 1.0:
            ...
            def display_plagiarised_text():
                ...
                if plagiarised_text:
                    text_box = tk.Text(window, font=("SF Pro Text Regular", 12), bg="#DDD1AE", fg=bg_color)
            ...
            display_button = tk.Button(root, text="Display Plagiarised Text", font=("JetBrains Mono", 12), bg=highlight_color, fg=button_color, command=display_plagiarised_text)
